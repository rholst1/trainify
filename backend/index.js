...
app.get('/api/db/getunoccupiedseats', (request, response) => {
  ...
  let query = `
    Select Schedule.Id AS ScheduleId, Schedule.DepartureTime, Schedule.ArrivalTime, Schedule.DepartureStationId, Schedule.ArrivalStationId, Schedule.Price, Schedule.TrainId, Train.Name, Seat.Id AS UniqueSeatId, Seat.WagonNr, Seat.SeatNr 
    From Schedule
    ...
    Except
    Select Schedule.Id AS ScheduleId,  Schedule.DepartureTime,  Schedule.ArrivalTime, Schedule.DepartureStationId, Schedule.ArrivalStationId, Schedule.TrainId, Train.Name, Ticket.SeatGuid, Seat.WagonNr, Seat.SeatNr
    From Ticket
